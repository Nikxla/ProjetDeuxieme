            ...
            <div class="row">
                <div class="col-lg-4 col-sm-12">
                    <div class="explain-icon"
                         style="background-image: url('img/About/303792.svg'); border-color: #ff8000"></div>
                    <h4 class="text-center pt-3 font-weight-bold" style="color: #ff8000">Anonymat</h4>
                    <p class="pstyle text-center">Ne vous inquiétez jamais des acheteurs ou des vendeurs légitimes -
                        nous sommes au centre.</p>
                </div>
                <div class="col-lg-4 col-sm-12">
                    <div class="explain-icon"
                         style="background-image: url('img/About/1114113.svg'); border-color: #32CD32"></div>
                    <h4 class="text-center pt-3 font-weight-bold" style="color: #32CD32">Transparence</h4>
                    <p class="pstyle text-center">Données de marché en temps réel pour des achats et des ventes
                        intelligents.</p>
                </div>
                <div class="col-lg-4 col-sm-12">
                    <div class="explain-icon"
                         style="background-image: url('img/About/294185.svg'); border-color: #00BFFF"></div>
                    <h4 class="text-center pt-3 font-weight-bold" style="color: #00BFFF">Authenticité</h4>
                    <p class="pstyle text-center">Nos experts authentifient chaque produit vendu sur notre
                        plateforme.</p>
                </div>
            </div>
        </article>
    ...
    <div class="container">
        ...
        <div class="pb-5">
            <div class="col-lg-2 col-sm-3 float-left">
                <div class="explain-icon2 float-left" style="background-image: url('img/About/hammer.svg')"></div>
            </div>
            <div class="col-lg-10 col-sm-9 float-right">
                <h4 style="color: white; font-size: 20pt;">BID (ACHETER)</h4>
                <p style="color: white; font-size: 15pt;">Faites une offre que tout vendeur peut accepter ou achetez
                    immédiatement au plus bas demandez.</p>
            </div>
        </div>
        <br><br><br><br><br><br>
        <div class="pb-5">
            <div class="col-lg-2 col-sm-3 float-left">
                <div class="explain-icon2 float-left" style="background-image: url('img/About/icon.svg')"></div>
            </div>
            <div class="col-lg-10 col-sm-9 float-right">
                <h4 style="color: white; font-size: 20pt;">AUTHENTIFIER</h4>
                <p style="color: white; font-size: 15pt;">Le vendeur nous envoie. Nous authentifions, puis nous libérons
                    des fonds au vendeur.</p>
            </div>
        </div>
        <br><br><br><br><br><br>
        <div class="pb-5">
            <div class="col-lg-2 col-sm-3 float-left">
                <div class="explain-icon2 float-left" style="background-image: url('img/About/cash.svg')"></div>
            </div>
            <div class="col-lg-10 col-sm-9 float-right">
                <h4 style="color: white; font-size: 20pt;">PROSPÉRER</h4>
                <p style="color: white; font-size: 15pt;">Nous livrons à vous. Vous sirotez un daiquiri, sachant que
                    vous ne recevrez jamais de faux.</p>
            </div>
        </div>
        <br><br><br><br>
    </div>
